...
@section('content')
    <div class="container">
        ...
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
          ...
          <form action="{{ route('guru.update', $gurus['id']) }}" method="POST" class="card p-5">
              ...
              <div class="mb-3 row">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="name" name="name" value="{{ $gurus['name'] }}">
                  </div>
              </div>
              <div class="mb-3 row">
                  <label for="name" class="col-sm-2 col-form-label">Email :</label>
                  <div class="col-sm-10">
                      <input type="text" class="form-control" id="email" name="email" value="{{ $gurus['email'] }}">
                  </div>
              </div>
              <div class="mb-3 row">
